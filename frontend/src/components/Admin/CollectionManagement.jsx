...
import { fetchCollections, createCollection, deleteCollection } from '../../redux/slices/collectionSlice';
import { HiTrash, HiPlus } from 'react-icons/hi';

const CollectionManagement = () => {
    const dispatch = useDispatch();
    const { collections = [], loading = false, error = null } = useSelector((state) => state.collections || {});
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await dispatch(createCollection(newCollection)).unwrap();
            setNewCollection('');
        } catch (err) {
