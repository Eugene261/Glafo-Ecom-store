...
import {TbBrandInstagram, TbBrandMeta, TbFilePhone,  } from 'react-icons/tb'
...
const Footer = () => {
  return <footer className='border-t py-12'>
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        ...
        <div>
            ...
            <form className="flex">
                ...
                required
                />
                <button type='submit' className='bg-black text-white px-6 py3 text-sm
    ...
    >
        ...
        © 2025, 704-Labs. All Rights reserved
        </p>
    </div>
  </footer>
}
