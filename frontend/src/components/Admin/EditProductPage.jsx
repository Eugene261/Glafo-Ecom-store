...
const EditProductPage = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        console.log(productData);  // Fixed: log productData instead of undefined file
    }
    ...
    <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md'>
        ...
        <form onSubmit={handleSubmit} >
            ...
            <div className="mb-6">
                ...
                <textarea
                name="description"  // Removed extra space
                value={productData.description}  // Fixed to match state property name
                onChange={handleChange}
            ...
            <div className="mb-6">
                ...
                <input
                type="number"
                name='countInStock'  // Changed from 'count-in-stock' to match state property
                value={productData.countInStock}  // Fixed spelling
                onChange={handleChange}
                className='w-full border border-gray-300 rounded-md p-2'
                />
            </div>
